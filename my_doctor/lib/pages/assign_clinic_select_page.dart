...
class AssignClinicPage extends StatefulWidget {
  const AssignClinicPage({super.key});

  @override
  State<AssignClinicPage> createState() =>
      _AssignClinicPageState();
}

class _AssignClinicPageState
    extends State<AssignClinicPage> {
