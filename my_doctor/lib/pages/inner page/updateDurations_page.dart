...
class UpdateDurationPage extends StatefulWidget {
  const UpdateDurationPage({Key? key, required this.onSubmit}) : super(key: key);
  final VoidCallback onSubmit;

  @override
  State<UpdateDurationPage> createState() => _UpdateDurationPageState();
}
