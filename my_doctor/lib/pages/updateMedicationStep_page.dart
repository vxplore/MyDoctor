...
import 'inner page/updateDurations_page.dart';

class UpdateMedicationStepsPage extends StatefulWidget {
  const UpdateMedicationStepsPage({Key? key}) : super(key: key);

  @override
  _UpdateMedicationStepsPageState createState() => _UpdateMedicationStepsPageState();
}

class _UpdateMedicationStepsPageState extends State<UpdateMedicationStepsPage>
