  ...
  List<Map<String, dynamic>> assistantRoles = [
    {
      ...
      "role_details": "Could be assigned to Receptionist pr Compounder",
      ...
      "feature_3_icon": "assets/images/star_icon.png",
      ...
      "feature_7_icon": "assets/images/star_icon.png",
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return CheckboxListTile(
                      value: selectedRoles.contains(assistantRoles[index]),
                      onChanged: (bool? value) {
                        setState(() {
                          if (value != null && value) {
                            ...
                            globalVariables.selectedAssistantRoleNames
                                .remove(assistantRoles[index]["role_name"]);
                          }
                        });
                      },
                      title: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("${assistantRoles[index]["role_name"]}",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                              Text("${assistantRoles[index]["role_details"]}",style: TextStyle(fontSize: 14,color: Colors.grey),),
                              assistantRoles[index]["feature_1_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_1_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                                            "${assistantRoles[index]["feature_1_name"]}",style: TextStyle(fontSize: 14,color: Colors.grey.shade800)),
                                      ],
                                    ),
                              assistantRoles[index]["feature_2_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_2_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                              ...
                              assistantRoles[index]["feature_3_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_3_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                              ...
                              assistantRoles[index]["feature_4_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_4_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                              ...
                              assistantRoles[index]["feature_5_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_5_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                              ...
                              assistantRoles[index]["feature_6_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_6_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                              ...
                              assistantRoles[index]["feature_7_icon"] == null
                                  ...
                                  : Row(
                                      children: [
                                        Image.asset(
                                          assistantRoles[index]["feature_7_icon"],
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
